								...
								<form action="<?= base_url('customer/proses_ubah/' . $customer->id) ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode" placeholder="Masukkan Kode WH" autocomplete="off"  class="form-control" required value="<?= $customer->kode ?>">
										</div>
										<div class="form-group col-md-6">
											<label for="nama"><strong>Nama</strong></label>
											<input type="text" name="nama" placeholder="Masukkan Nama WH" autocomplete="off"  class="form-control" required value="<?= $customer->nama ?>">
										</div>
									</div>
									<div class="form-row">
