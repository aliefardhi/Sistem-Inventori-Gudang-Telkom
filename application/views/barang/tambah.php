								...
								<form action="<?= base_url('barang/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode_barang" placeholder="Masukkan SN" autocomplete="off"  class="form-control">
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-4">
											<label for="stok"><strong>Jumlah</strong></label>
											<input type="number" name="stok" placeholder="Masukkan Jumlah" autocomplete="off"  class="form-control" required>
										</div>
										<div class="form-group col-md-4">
										...
										<div class="form-group col-md-4">
											...
											<input type="date" name="tgl_masuk" value="<?= date('d/m/Y') ?>" class="form-control" required>
										</div>
									</div>
									<hr>
