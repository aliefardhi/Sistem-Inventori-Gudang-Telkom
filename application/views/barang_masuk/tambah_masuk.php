            ...
            <form action="<?= base_url('tambah_masuk/tambah_aksi'); ?>" method="post" class="mt-2">
                <table class="m-sm-auto">
                    <tr>
                        ...
                        <td><input style="padding: 10px; width:370px; height: 30px; border-radius:5px; background: #C0C0C0; border-color: #808080; border: 5px; margin-bottom: 18px; margin-top: 20px;" type="text" name="whmasuk" value="<?= set_value('whmasuk'); ?>">
